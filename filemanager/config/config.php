...
$base_url="http://localhost/geosolution";  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir = '/upload/images/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../upload/images/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../upload/_thumbs/Images/'; // relative path from filemanager folder to thumbs folder (with final /)
