                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                <div class="form-horizontal">
                                    <fieldset>
                                        <legend>Merubah Bahasa</legend>
                                        <?php foreach($get_some as $key): ?>
                                            <div class="control-group">
                                                <label class="control-label" for="typeahead">Nama Kategori</label>
                                                <div class="controls">
                                                    <input type="hidden" name="ID_LANG" value="<?= $key->ID_LANG ?>"><!-- input -->
                                                    <input class="input-xlarge focused" id="focusedInput" type="text" name="LANG" value="<?= $key->LANG ?>"><!-- input -->
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label" for="typeahead">Urutan ke-</label>
                                                <div class="controls">
                                                    <input class="input-xlarge focused" id="focusedInput" type="text" name="ORDERING_LANG" value="<?= $key->ORDERING_LANG ?>"><!-- input -->
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label" for="typeahead">Status Online</label>
                                                <div class="controls">
                                                    <select name="ONLINE_LANG" id="ONLINE_LANG"><!-- input -->
                                                        <option selected="selected" value=<?= $key->ONLINE_LANG ?>><?= ($key->ONLINE_LANG=="1")?"Yes":"No" ?></option>
