                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                <div class="form-horizontal">
                                    <fieldset>
                                        <legend>Merubah Data Pengguna</legend>
                                        <?php foreach($get_some as $key): ?>
                                            <div class="control-group">
                                                <label class="control-label" for="typeahead">Nama Pengguna</label>
                                                <div class="controls">
                                                    <input type="hidden" name="ID_USER" value="<?= $key->ID_USER ?>"><!-- input -->
                                                    <input class="input-xlarge focused" id="focusedInput" type="text" name="USERNAME" value="<?= $key->USERNAME ?>"><!-- input -->
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select name="ID_GROUP" id="ID_GROUP"><!-- input -->
                                                        <option selected="selected" value=<?= $key->ID_GROUP ?>><?= $key->GROUP_NAME ?></option>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input class="input-xlarge focused" id="focusedInput" type="text" name="EMAIL" value="<?= $key->EMAIL ?>"><!-- input -->
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select name="ACTIVE" id="ACTIVE"><!-- input -->
                                                        <option selected="selected" value=<?= $key->ACTIVE ?>><?= ($key->ACTIVE=="1")?"Yes":"No" ?></option>
