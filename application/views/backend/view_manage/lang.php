                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                ...
                                <?php foreach($get_all as $key=>$val): ?>
                                    ...
                                    <i class="icon-remove icon-white"></i>
                                        ...
                                        <td>
                                            <button class="btn btn-primary" onclick="window.location='<?= base_url().'backoffice/'.$this->uri->segment(2).'/edit/'.$val->ID_LANG ?>';">
                                                <i class="icon-pencil icon-white"></i>
                                                Edit
                                            </button>
                                            <a href="#deletePopUp" onclick="javascript:setNameDelete('<?= $val->LANG ?>','<?= $val->ID_LANG ?>')" data-toggle="modal" class="btn btn-danger"><i class="icon-remove icon-white"></i>Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
