...
<!--                                        <td>--><?php //echo date("d-m-Y h:m:s",$val->LAST_VISIT) ?><!--</td>-->
                                        <td> <?= date("d-m-Y h:m:s",$val->JOIN_DATE) ?></td>
                                        <td class="center">
                                            <?php if($val->ACTIVE){ ?>
                                    ...
                                    <i class="icon-remove icon-white"></i>
                                        ...
                                        <td>
                                            <button class="btn btn-primary" onclick="window.location='<?= base_url().'backoffice/'.$this->uri->segment(2).'/edit/'.$val->ID_USER ?>';">
                                                <i class="icon-pencil icon-white"></i>
                                                Edit
                                            </button>
                                            <a href="#deletePopUp" onclick="javascript:setNameDelete('<?= $val->USERNAME ?>','<?= $val->ID_USER ?>')" data-toggle="modal" class="btn btn-danger"><i class="icon-remove icon-white"></i>Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
