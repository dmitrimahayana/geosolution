                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                    ...
                    <?php foreach($get_all as $key=>$val): ?>
                        <tr class="">
                            ...
                            <td><?= $key ?></td>
                            <td><?= $val->NAME_PAGE ?></td>
                            <td><?= date('Y-m-d H:i:s', $val->TIME_PAGE) ?></td>
                            <td> <?= $val->METADATA ?></td>
                            <td class="center">
                                <?php if($val->ONLINE_PAGE){ ?>
                            ...
                            <td>
                                <button class="btn btn-primary" onclick="window.location='<?= base_url().'backoffice/'.$this->uri->segment(2).'/edit/'.$val->ID_PAGE ?>';">
                                    <i class="icon-pencil icon-white"></i>
                                    Edit
                                </button>
                                <a href="#deletePopUp" onclick="javascript:setNameDelete('<?= $val->NAME_PAGE ?>','<?= $val->ID_PAGE ?>')" data-toggle="modal" class="btn btn-danger"><i class="icon-remove icon-white"></i>Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
