                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                <div class="form-horizontal">
                                    <fieldset>
                                        <legend>Menambah Bahasa</legend>
                                        <div class="control-group">
                                            <label class="control-label" for="typeahead">Nama Bahasa</label>
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="LANG" value=""><!-- input -->
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="typeahead">Urutan ke-</label>
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="ORDERING_LANG" value=""><!-- input -->
                                            </div>
                                        </div>
                                        <div class="control-group">
