                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                <div class="form-horizontal">
                                    <fieldset>
                                        <legend>Menambah Kategori Menu Depan</legend>
                                        <div class="control-group">
                                            <label class="control-label" for="typeahead">Nama Kategori</label>
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="NAME_CATEGORY" value=""><!-- input -->
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label" for="typeahead">Kode</label>
                                            <div class="controls">
                                                <input class="input-xlarge focused" id="focusedInput" type="text" name="CODE_CATEGORY" value=""><!-- input -->
                                            </div>
                                        </div>
                                        <div class="control-group">
